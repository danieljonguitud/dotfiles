...
-- Disable netrw early to prevent it from loading
...
require('lazy').setup({
...

  {
    ...
    opts = {},
    config = function()
      -- Set a default colorscheme immediately to prevent flashing
      -- This will be overridden by auto-dark-mode if needed
